def main():
    ...
    #                 print(l1) 
                    ...
                    regex_for_special_string = '[@_!#$%.^&*()<>?/\|}{~:]'         # kch problem aaya toh yaha se . ko remove kr dena(float,time,string mai)
